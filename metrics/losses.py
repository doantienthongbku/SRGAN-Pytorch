...
class ContentLoss(nn.Module):
    def __init__(self,
        ...
        self.feature_extractor = create_feature_extractor(model=model, node=[feature_model_extractor_node])
    ...
    def forward(self, sr_image, hr_image):
        ...
        sr_image_feature = self.feature_extractor(sr_image)
        hr_image_feature = self.feature_extractor(hr_image)
